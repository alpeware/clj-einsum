...
| :--- | :--- | :--- | :--- | :--- |
| **GPT-2 (Small/Med/Large/XL)** | Decoder Causal LM (MHA) | [Spec & Graph](../models/gpt2.md) | [`einsum.models.gpt2`](../../src/einsum/models/gpt2.clj) | **Verified** (CPU, SYCL, ROCm) |
| **SmolLM (135M/360M/1.7B)** | Lightweight Edge LM (GQA/SwiGLU) | [Spec & Graph](../models/smollm.md) | [`einsum.models.smollm`](../../src/einsum/models/smollm.clj) | **Verified** (CPU, SYCL) |
| **Gemma 2 (2B/9B/27B)** | GQA, Gemma RMSNorm ($1+w$) | [Spec & Graph](../models/gemma2.md) | [`einsum.models.gemma`](../../src/einsum/models/gemma.clj) | **Verified** (CPU, SYCL) |
| **Gemma 3 (1B/4B/12B/27B)** | Gemma 3 Architecture | [Spec & Graph](../models/gemma3.md) | [`einsum.models.gemma3`](../../src/einsum/models/gemma3.clj) | **Verified** (CPU, SYCL) |
| **Gemma 4 (E2B/E4B)** | Gemma 4 Per-Layer Gating | [Spec & Graph](../models/gemma4_e2b_e4b.md) | [`einsum.models.gemma`](../../src/einsum/models/gemma.clj) | **Verified** (CPU, Intel Arc SYCL) |
