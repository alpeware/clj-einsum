...
| **Safetensors INT8 Quantization** | Header JSON + Tensor Loading | [Wiki](../wiki/quantization.md) | [`einsum.runtime.safetensors`](../../src/einsum/runtime/safetensors.clj) | **Verified** |
...
| :--- | :--- | :--- | :--- | :--- |
| **Gemma 4 26B-A4B MoE** | [Spec & Graph](../models/gemma4_26b_a4b.md) | **High** | `models.gemma4-moe` | 8-expert sparse MoE router (2 active experts, 3.9B active params) |
| **Meta Muse-Glimmer-30B** | [Spec & Graph](../models/muse_glimmer_30b.md) | **High** | `einsum.logic.models.muse-glimmer` | ViT-G/14 Vision Encoder, DFlash 16-token block speculative predictor, ATEM tool markup |
| **DeepSeek-V3 / MLA** | [Wiki](../wiki/attention.md) | **High** | `einsum.logic.nn` | Multi-Head Latent Attention (576-dim latent vector compression) |
| **In-Graph INT4 / FP4 Dequant** | [Wiki](../wiki/quantization.md) | **High** | `einsum.logic.nn` | StableHLO in-graph de-quantization fused into GEMM kernels |
| **EAGLE-2 Speculative Decoding** | [Wiki](../wiki/speculative_decoding.md) | **Medium** | `einsum.runtime.generation` | Tree-structured candidate draft verification pass |
