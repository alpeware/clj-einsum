(ns clj-xla.logic.constrained-search-test
  "Unit and generative property tests for clj-xla.logic.constrained-search (Experiment E20).
   Repository Rule 1: Generative tests for invariants."
  (:require [clj-xla.logic.constrained-search :as cs]
