(ns clj-xla.logic.predicate-crystallization-test
  "Unit and generative property tests for clj-xla.logic.predicate-crystallization.
   Repository Rule 1: Generative tests for invariants."
  (:require [clj-xla.logic.predicate-crystallization :as pc]
