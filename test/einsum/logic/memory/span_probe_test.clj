(ns einsum.logic.memory.span-probe-test
  "Unit and generative tests for span-pooled probe ablation helpers in tools.poc-span-probe:
   subsequence search, head span location, and pooling operations (mean/max)."
  (:require [einsum.runtime.tokenizer.core :as tok]
            [einsum.runtime.tokenizer.protocol :as tok-proto :refer [bos-id decode encode]]
            [clojure.edn :as edn]
