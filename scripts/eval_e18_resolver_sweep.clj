(ns scripts.eval-e18-resolver-sweep
  ...
  (:require [clj-xla.core :as xla]
            ...
            [clj-xla.logic.memory.sampler :as sampler]
...
(defn run-e18-sweep! [opts]
  ...
  (let [model-dir (or (:model-dir opts) ".models/gemma-4-E2B-it")
        ...
        out-edn (or (:out-edn opts) "paper-experiments/e18-diagnostics/2026-09-17/phase1_results.edn")
        out-csv (or (:out-csv opts) "paper-experiments/e18-diagnostics/2026-09-17/summary.csv")
