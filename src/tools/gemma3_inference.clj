...
(defn parse-cli-args
  "Parses command-line flags (--prompt, --max-new-tokens, --temperature, --top-k, --backend, --precision, --chat, --model-dir, --verbose)."
  [args]
  (loop [cli-args args
    ...
    (if (seq cli-args)
      (let [arg (first cli-args)]
        (cond
          ...
          (= arg "--chat")
          (recur (drop 2 cli-args) (assoc opts :chat (Boolean/parseBoolean (second cli-args))))
